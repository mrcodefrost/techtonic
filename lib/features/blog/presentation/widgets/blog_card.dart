...
import 'package:techtonic_blog_app/features/blog/presentation/pages/blog_viewer_screen.dart';
...
class BlogCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        margin: const EdgeInsets.all(16).copyWith(bottom: 4), // out of container
